---
kind: logging_system
name: Alibaba Cloud SLS-Based Log Archive and Audit Infrastructure
category: logging_system
scope:
    - '**'
source_files:
    - modules/lza/components/log-archive/actiontrail/main.tf
    - modules/lza/components/log-archive/config/main.tf
    - modules/lza/components/log-archive/event-alert/main.tf
    - modules/lza/components/log-archive/log-audit/main.tf
    - modules/lza/modules/sls-project/main.tf
    - modules/lza/modules/sls-logstore/main.tf
    - bootstrap/02-spoke-bootstrap/providers.tf
